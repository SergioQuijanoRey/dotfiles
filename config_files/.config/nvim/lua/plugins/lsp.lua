return {
    -- Builtin lsp
    {
        ...
        config = function()
            ...
            setmap("n", "<leader>qs", function() vim.lsp.buf.signature_help { border = "rounded" } end, bufopts,
                "Signature help")
            setmap("n", "<leader>qh", function() vim.lsp.buf.hover { border = "rounded" } end, bufopts, "Hover (docs)")
