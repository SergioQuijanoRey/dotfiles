...
-- For sharing tags among two screens
local sharedtags = require("sharedtags")


-- Load splitted modules of the config
-- =============================================================================
...
-- I comment every layout except from tile, so only tile should be available
...
-- I am using simple feh for setting wallpapers
-- TODO -- look at this because it sets wallpaper automatically when screen changes are seen
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Remove this because we are using shared tags
